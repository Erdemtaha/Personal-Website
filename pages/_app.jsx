...
function MyApp({ Component, pageProps }) {
  ...
  return (<>
    <Head>
        <title>Erdem Taha</title>
        <link rel="shortcut icon" href="https://media.discordapp.net/attachments/737348411568685066/954506783777493072/Erden_Taha_Icon.png" type="image/x-icon" ></link>
        ...
        <div style={{ zIndex: 99999 }} className="fixed bg-black/75 w-full h-screen flex justify-center items-center pointer-events-none">
            <div className="flex items-center gap-x-6 animate-pulse">
                <div className="text-center">
                    <p className="text-6xl mb-5 font-semibold">Erdem Taha</p>
