...
const items = [
    { icon: 'fab fa-youtube', link: 'https://www.youtube.com/channel/UCPKJUziVe7O9-MQ8BWAMTWw' },
    { icon: 'fab fa-discord', link: 'https://discord.gg/qE6DX3pbYP' },
    { icon: 'fab fa-instagram', link: 'https://instagram.com/erdemincdy' },
  ]
...
const navItems = [
    ...
    { icon: 'fal fa-rss', active: 'fa fa-rss', label: 'Blogs', href: 'https://blog.erdem.life' }
]
